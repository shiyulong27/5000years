...
describe('2010-2024 年 5 级（⭐⭐⭐⭐⭐ 历史转折）重大事件配图 100% 全覆盖验证', () => {
  const events = [
  ...
  it('2010-2024 年共有 157 条 5 级重大事件', () => {
    expect(major5StarEvents.length).toBe(157)
  })

  it('所有 157 条 5 级重大事件必须 100% 配置图片、本地物理存在且具备非空图注', () => {
