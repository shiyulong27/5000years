...
describe('2000-2024 年 5 级（⭐⭐⭐⭐⭐ 历史转折）重大事件配图 100% 全覆盖强约束验证', () => {
  const events = [
  ...
  it('2000-2024 年共有 279 条 5 级重大事件', () => {
    expect(major5StarEvents.length).toBe(279)
  })

  it('所有 279 条 5 级重大事件必须 100% 配置图片、本地物理存在且具备非空图注', () => {
