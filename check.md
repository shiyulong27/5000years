...
## 1933 年事件补全审查（2026-08-14）

- 审查范围：1933 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1933 年事件，且无 `src/pages/1933.astro` 与时间轴入口。
- 修改后统计：新增中国事件 3 条、世界事件 5 条；其中五星事件 3 条、四星事件 5 条；3 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1933.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1933 年入口。
- 已读取/核验来源：中英文维基百科 1933 年、长城抗战、塘沽协定、第五次围剿、希特勒出任德国总理、德国国会纵火案、罗斯福新政、德国授权法、德国退出国际联盟等条目；补查 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1933 年年度十大新闻正文，已用维基百科和历史条目交叉核验。
- 新增中国事件：`cn-defense-great-wall-193301`、`cn-tanggu-truce-193305`、`cn-fifth-encirclement-begins-193309`。
- 新增世界事件：`w-hitler-chancellor-193301`、`w-reichstag-fire-193302`、`w-new-deal-begins-193303`、`w-enabling-act-193303`、`w-germany-leaves-league-193310`。
- 暂无合格本地配图：`w-hitler-chancellor-193301`、`w-new-deal-begins-193303`、`w-enabling-act-193303`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 5 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
...
## 1931 年事件补全审查（2026-08-14）

- 审查范围：1931 年中国事件与世界事件；此前中国侧仅有年份精度的 `september-18-incident-1931`，世界侧无 1931 年事件，且无 `src/pages/1931.astro` 与时间轴入口。
- 修改后统计：将 `september-18-incident-1931` 日期精确到 `1931-09-18` 并补充 tags/sources/summary；新增中国事件 1 条、世界事件 4 条；共有五星事件 3 条、四星事件 3 条；3 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1931.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1931 年入口。
- 已读取/核验来源：中英文维基百科 1931 年、九一八事变、江桥抗战、西班牙第二共和国、金本位制、满洲事变/满洲危机、胡佛延期偿付等条目；补查中国共产党新闻网和 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1931 年年度十大新闻正文，已用维基百科、党史资料和历史条目交叉核验。
- 新增/修正中国事件：修正 `september-18-incident-1931`；新增 `cn-nenjiang-bridge-resistance-193111`。
- 新增世界事件：`w-spanish-second-republic-193104`、`w-uk-leaves-gold-standard-193109`、`w-manchurian-crisis-193109`、`w-hoover-moratorium-193106`。
- 暂无合格本地配图：`september-18-incident-1931`、`w-uk-leaves-gold-standard-193109`、`w-manchurian-crisis-193109`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 3 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 858 条事件、47 个朝代、65 位君主、782 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1931 年 3 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1930 年事件补全审查（2026-08-14）

- 审查范围：1930 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1930 年事件，且无 `src/pages/1930.astro` 与时间轴入口。
- 修改后统计：新增中国事件 4 条、世界事件 6 条；其中五星事件 2 条、四星事件 8 条；2 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1930.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1930 年入口。
- 已读取/核验来源：中英文维基百科 1930 年、中原大战、中国左翼作家联盟、第一次反围剿、威海卫、盐进军、伦敦海军条约、冥王星发现、斯姆特-霍利关税法、首届世界杯、1930 年德国国会选举等条目；补查 NASA、FIFA、美国国会资料和 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1930 年年度十大新闻正文，已用维基百科、机构资料和历史条目交叉核验。
- 新增中国事件：`cn-left-wing-writers-league-193003`、`cn-central-plains-war-193005`、`cn-weihaiwei-returned-193010`、`cn-first-encirclement-jiangxi-193011`。
- 新增世界事件：`w-pluto-discovered-193002`、`w-salt-march-193003`、`w-london-naval-treaty-193004`、`w-smoot-hawley-tariff-193006`、`w-first-fifa-world-cup-193007`、`w-german-federal-election-193009`。
- 暂无合格本地配图：`w-salt-march-193003`、`w-smoot-hawley-tariff-193006`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 8 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 862 条事件、47 个朝代、65 位君主、788 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1930 年 2 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1929 年事件补全审查（2026-08-14）

- 审查范围：1929 年中国事件与世界事件；此前世界侧仅有年份精度的 `w-great-depression-1929`，中国侧无 1929 年事件，且无 `src/pages/1929.astro` 与时间轴入口。
- 修改后统计：将 `w-great-depression-1929` 日期精确到 `1929-10-24` 并补充 sources/summary；新增中国事件 4 条、世界事件 4 条；共有五星事件 3 条、四星事件 6 条；3 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1929.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1929 年入口。
- 已读取/核验来源：中英文维基百科 1929 年、蒋桂战争、中东路事件、百色起义、古田会议、拉特兰条约、首届奥斯卡金像奖、1929 年战俘待遇日内瓦公约、华尔街股灾、杨格计划等条目；补查 ICRC、奥斯卡官网、美国国务院历史资料和 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1929 年年度十大新闻正文，已用维基百科、机构资料和历史条目交叉核验。
- 新增中国事件：`cn-chiang-gui-war-192903`、`cn-sino-soviet-conflict-192907`、`cn-baise-uprising-192912`、`cn-gutian-congress-192912`。
- 新增/修正世界事件：修正 `w-great-depression-1929`；新增 `w-lateran-treaty-192902`、`w-first-academy-awards-192905`、`w-geneva-pow-convention-192907`、`w-young-plan-192909`。
- 暂无合格本地配图：`cn-gutian-congress-192912`、`w-lateran-treaty-192902`、`w-great-depression-1929`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 6 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 866 条事件、47 个朝代、65 位君主、792 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1929 年 3 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1928 年事件补全审查（2026-08-14）

- 审查范围：1928 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1928 年事件，且无 `src/pages/1928.astro` 与时间轴入口。
- 修改后统计：新增中国事件 4 条、世界事件 5 条；其中五星事件 4 条、四星事件 5 条；4 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1928.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1928 年入口。
- 已读取/核验来源：中英文维基百科 1928 年、济南惨案、皇姑屯事件、北伐、东北易帜、1928 年人民代表法、凯洛格-白里安公约、青霉素发现、苏联第一个五年计划、《汽船威利号》等条目；补查英国议会资料、诺贝尔奖官网、迪士尼资料和 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1928 年年度十大新闻正文，已用维基百科、机构资料和历史条目交叉核验。
- 新增中国事件：`cn-jinan-incident-192805`、`cn-huanggutun-incident-192806`、`cn-northern-expedition-beijing-192806`、`cn-northeast-flag-replacement-192812`。
- 新增世界事件：`w-uk-equal-franchise-192807`、`w-kellogg-briand-pact-192808`、`w-penicillin-discovered-192809`、`w-soviet-first-five-year-plan-192810`、`w-steamboat-willie-192811`。
- 暂无合格本地配图：`cn-northeast-flag-replacement-192812`、`w-kellogg-briand-pact-192808`、`w-penicillin-discovered-192809`、`w-soviet-first-five-year-plan-192810`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 5 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 876 条事件、47 个朝代、65 位君主、797 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1928 年 4 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1927 年事件补全审查（2026-08-14）

- 审查范围：1927 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1927 年事件，且无 `src/pages/1927.astro` 与时间轴入口。
- 修改后统计：新增中国事件 5 条、世界事件 5 条；其中五星事件 3 条、四星事件 7 条；3 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1927.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1927 年入口。
- 已读取/核验来源：中英文维基百科 1927 年、南京事件、四一二事件、南昌起义、秋收起义、广州起义、林德伯格跨大西洋飞行、法恩斯沃斯电子电视、《爵士歌手》、第五届索尔维会议、托洛茨基等条目；补查 Smithsonian、IEEE 和 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1927 年年度十大新闻正文，已用维基百科、机构资料和历史条目交叉核验。
- 新增中国事件：`cn-nanjing-incident-192703`、`cn-shanghai-massacre-192704`、`cn-nanchang-uprising-192708`、`cn-autumn-harvest-uprising-192709`、`cn-guangzhou-uprising-192712`。
- 新增世界事件：`w-lindbergh-flight-192705`、`w-farnsworth-television-192709`、`w-jazz-singer-192710`、`w-solvay-conference-192710`、`w-trotsky-expelled-192711`。
- 暂无合格本地配图：`cn-shanghai-massacre-192704`、`cn-nanchang-uprising-192708`、`cn-autumn-harvest-uprising-192709`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 7 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 881 条事件、47 个朝代、65 位君主、802 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1927 年 3 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1926 年事件补全审查（2026-08-14）

- 审查范围：1926 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1926 年事件，且无 `src/pages/1926.astro` 与时间轴入口。
- 修改后统计：新增中国事件 4 条、世界事件 6 条；其中五星事件 3 条、四星事件 7 条；3 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1926.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1926 年入口。
- 已读取/核验来源：中英文维基百科 1926 年、中山舰事件、北伐、万县事件、武昌战役、戈达德液体燃料火箭、英国总罢工、德国加入国际联盟、NBC、贝尔福宣言、昭和时代等条目；补查 NASA、NBC 和 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1926 年年度十大新闻正文，已用维基百科、机构资料和历史条目交叉核验。
- 新增中国事件：`cn-zhongshan-warship-incident-192603`、`cn-northern-expedition-begins-192607`、`cn-wanxian-incident-192609`、`cn-wuchang-captured-192610`。
- 新增世界事件：`w-goddard-liquid-rocket-192603`、`w-uk-general-strike-192605`、`w-germany-league-nations-192609`、`w-balfour-declaration-192611`、`w-nbc-radio-network-192611`、`w-showa-era-begins-192612`。
- 暂无合格本地配图：`cn-northern-expedition-begins-192607`、`w-goddard-liquid-rocket-192603`、`w-balfour-declaration-192611`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 7 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 885 条事件、47 个朝代、65 位君主、808 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1926 年 3 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1925 年事件补全审查（2026-08-14）

- 审查范围：1925 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1925 年事件，且无 `src/pages/1925.astro` 与时间轴入口。
- 修改后统计：新增中国事件 4 条、世界事件 6 条；其中五星事件 3 条、四星事件 7 条；3 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1925.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1925 年入口。
- 已读取/核验来源：中英文维基百科 1925 年、孙中山、五卅运动、省港大罢工、广州国民政府、诺姆血清接力、斯科普斯审判、《我的奋斗》、洛迦诺公约、贝尔德电视实验、巴列维王朝等条目；补查 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1925 年年度十大新闻正文，已用维基百科和历史条目交叉核验。
- 新增中国事件：`cn-sun-yat-sen-death-192503`、`cn-may-thirtieth-movement-192505`、`cn-canton-hongkong-strike-192506`、`cn-guangzhou-national-government-192507`。
- 新增世界事件：`w-serum-run-nome-192501`、`w-scopes-trial-192507`、`w-mein-kampf-volume1-192507`、`w-locarno-treaties-192510`、`w-baird-television-192510`、`w-pahlavi-dynasty-192512`。
- 暂无合格本地配图：`cn-sun-yat-sen-death-192503`、`cn-may-thirtieth-movement-192505`、`w-locarno-treaties-192510`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 7 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 889 条事件、47 个朝代、65 位君主、814 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1925 年 3 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1924 年事件补全审查（2026-08-14）

- 审查范围：1924 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1924 年事件，且无 `src/pages/1924.astro` 与时间轴入口。
- 修改后统计：新增中国事件 4 条、世界事件 5 条；其中五星事件 4 条、四星事件 5 条；4 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1924.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1924 年入口。
- 已读取/核验来源：中英文维基百科 1924 年、国民党一大、黄埔军校、北京政变、孙中山北上、列宁逝世、英国首届工党政府、废除哈里发、道威斯计划、《超现实主义宣言》等条目；补查 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1924 年年度十大新闻正文，已用维基百科和历史条目交叉核验。
- 新增中国事件：`cn-kmt-first-congress-192401`、`cn-whampoa-military-academy-192406`、`cn-beijing-coup-192410`、`cn-sun-yat-sen-northbound-192411`。
- 新增世界事件：`w-lenin-death-192401`、`w-first-labour-government-uk-192401`、`w-caliphate-abolished-192403`、`w-dawes-plan-192408`、`w-surrealist-manifesto-192410`。
- 暂无合格本地配图：`cn-kmt-first-congress-192401`、`cn-whampoa-military-academy-192406`、`w-lenin-death-192401`、`w-caliphate-abolished-192403`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 5 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 893 条事件、47 个朝代、65 位君主、819 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1924 年 4 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1923 年事件补全审查（2026-08-14）

- 审查范围：1923 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1923 年事件，且无 `src/pages/1923.astro` 与时间轴入口。
- 修改后统计：新增中国事件 4 条、世界事件 6 条；其中五星事件 5 条、四星事件 5 条；5 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1923.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1923 年入口。
- 已读取/核验来源：中英文维基百科 1923 年、孙文越飞宣言、二七惨案、中共三大、曹锟贿选、洛桑条约、关东大地震、迪士尼、土耳其共和国、啤酒馆政变、德国恶性通胀/伦滕马克等条目；补查 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1923 年年度十大新闻正文，已用维基百科和历史条目交叉核验。
- 新增中国事件：`cn-sun-joffe-manifesto-192301`、`cn-february-seventh-strike-192302`、`cn-cpc-third-congress-192306`、`cn-cao-kun-bribery-election-192310`。
- 新增世界事件：`w-treaty-lausanne-192307`、`w-great-kanto-earthquake-192309`、`w-disney-founded-192310`、`w-turkish-republic-192310`、`w-beer-hall-putsch-192311`、`w-rentenmark-introduced-192311`。
- 暂无合格本地配图：`cn-cpc-third-congress-192306`、`w-treaty-lausanne-192307`、`w-great-kanto-earthquake-192309`、`w-turkish-republic-192310`、`w-rentenmark-introduced-192311`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 5 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 897 条事件、47 个朝代、65 位君主、825 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1923 年 5 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。

## 1922 年事件补全审查（2026-08-14）

- 审查范围：1922 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1922 年事件，且无 `src/pages/1922.astro` 与时间轴入口。
- 修改后统计：新增中国事件 4 条、世界事件 6 条；其中五星事件 4 条、四星事件 6 条；4 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1922.astro`，并在 `Timeline.astro` 与 `AxisCell.astro` 注册 1922 年入口。
- 已读取/核验来源：中英文维基百科 1922 年、香港海员大罢工、第一次直奉战争、陈炯明兵变、中共二大、华盛顿海军条约、埃及独立、BBC、向罗马进军、爱尔兰自由邦、苏联成立等条目；补查 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1922 年年度十大新闻正文，已用维基百科和历史条目交叉核验。
- 新增中国事件：`cn-hong-kong-seamen-strike-192201`、`cn-first-zhili-fengtian-war-192204`、`cn-chen-jiongming-revolt-192206`、`cn-cpc-second-congress-192207`。
- 新增世界事件：`w-washington-naval-treaty-192202`、`w-egypt-independence-192202`、`w-bbc-founded-192210`、`w-march-on-rome-192210`、`w-irish-free-state-192212`、`w-soviet-union-founded-192212`。
- 暂无合格本地配图：`cn-cpc-second-congress-192207`、`w-march-on-rome-192210`、`w-irish-free-state-192212`、`w-soviet-union-founded-192212`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 6 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
...
## 1920 年事件补全审查（2026-08-14）

- 审查范围：1920 年中国事件与世界事件；此前 `data/events/minguo.yaml`、`data/world/modern.yaml` 中均无 1920 年事件，且无 `src/pages/1920.astro`；时间轴入口已包含 1920 年。
- 修改后统计：新增中国事件 4 条、世界事件 6 条；其中五星事件 6 条、四星事件 4 条；6 条五星事件因当前 Wikimedia 下载限流暂未写入图片字段。
- 页面与路由：新增 `src/pages/1920.astro`；`Timeline.astro` 与 `AxisCell.astro` 已包含 1920 年入口，本次未重复修改。
- 已读取/核验来源：中英文维基百科 1920 年、上海共产党早期组织、直皖战争、上海社会主义青年团、海原大地震、国际联盟、凡尔赛条约、卡普政变、色佛尔条约、华沙战役、美国第十九修正案等条目；补查美国国家档案馆和 Wikimedia Commons 图片候选。1978 年以前未找到可直接作为年度新闻清单的新华社 1920 年年度十大新闻正文，已用维基百科、机构资料和历史条目交叉核验。
- 新增中国事件：`cn-shanghai-communist-group-192008`、`cn-zhili-anhui-war-192007`、`cn-socialist-youth-league-192008`、`cn-haiyuan-earthquake-192012`。
- 新增世界事件：`w-league-of-nations-founded-192001`、`w-treaty-versailles-effective-192001`、`w-kapp-putsch-192003`、`w-treaty-sevres-192008`、`w-battle-warsaw-192008`、`w-us-19th-amendment-192008`。
- 暂无合格本地配图：`cn-shanghai-communist-group-192008`、`cn-haiyuan-earthquake-192012`、`w-league-of-nations-founded-192001`、`w-treaty-versailles-effective-192001`、`w-battle-warsaw-192008`、`w-us-19th-amendment-192008`。当前 Wikimedia 下载持续限流，未落地真实图片文件；为避免引用不存在文件，本次保持无图并记录待后续补图。
- 未配图说明：其余 4 条四星事件不强制配图；未使用版权不明图片或与事件关联较弱的现代纪念设施图。
- 验证：`npm run validate` 通过，校验 908 条事件、47 个朝代、65 位君主、843 条世界事件，保留既有 12 条君主缺口提示；脚本检查 1920 年 6 条五星缺图与本节记录一致，且无图片字段引用不存在文件；`git diff --check` 通过；`npx vitest run test/load.test.js test/validate.test.js test/1948-events.test.js` 通过（3 个测试文件、71 项测试）；`npx vitest run test/2020-2024-event-images.test.js --testTimeout=30000` 通过（1 个测试文件、1 项全局配图审计）。
