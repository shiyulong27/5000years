...
- [ ] **Step 2: 君主**：皇太极（founder, note 定国号清）、康熙（note）、宣统（last）。

- [ ] **Step 3: 人物**：曹雪芹（约1715–1763，文学，有争议，dispute: 生卒年无定论，卒年亦有 1764 说。）

- [ ] **Step 4: 验收 + 强模型复审晚清段**（表述中性）。**提交** `feat(data): 清代数据`；改状态。
